...
export default function PokemonListSection({ onPageChange }: PokemonListSectionProps) {
    ...
    return (
        <div className="flex flex-col justify-center items-center pb-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-12 px-0 sm:px-8 md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1350px]">
